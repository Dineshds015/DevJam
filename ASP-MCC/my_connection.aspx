...
<ItemStyle BorderColor="White" BorderWidth="50px" BackColor="#F7F6F3" ForeColor="#333333"></ItemStyle>
        ...
        <ItemTemplate >
            <table border="0" style="">
                <tr>
                    <td rowspan="7" Height="150px" Width="300px" style="background-color:antiquewhite; filter-blur:5px; box-shadow: inset 0px 0px 50px rgba(0,0,0,0.5); border-radius:20px; align-content:center;"><asp:Image ID="img_c_image" style=" box-shadow: inset 0px 0px 10px rgba(0,0,0,0.5);" runat="server" ImageUrl='<%#Eval("s_image") %>' Type="String" Height="150px" Width="140px" AlternateText="Picture not found"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                ...
                <tr><td>Course</td><td>:&nbsp</td><td><asp:Label ID="lbl_course" runat="server" Text='<%#Eval("s_course") %>'></asp:Label></td></tr>
                <tr><td>City</td><td>:&nbsp</td><td><asp:Label ID="lbl_ciy" runat="server" Text='<%#Eval("s_city") %>' Width="300"></asp:Label></td></tr>
                ...
                <tr><td style="text-align: center"><asp:Image ID="img_whatsapp" runat="server" src="Content/Design%20Images/whatsapp_logo.png" Height="20" Width="20"/></td><td>:&nbsp</td><td><asp:Label ID="lbl_cust_num" runat="server" Text="Whatsapp num"></asp:Label>  </td></tr>
                <tr>
                    <td colspan="4"><asp:Button ID="btn_approve" runat="server" Text="Disconnect" class="btn btn-primary transparent-style mr-3" CommandName="disconnect" Width="98%"/></td>
                </tr>
                </tr>
            </table>
            <table>
                <tr>
                    <td><asp:Label ID="lbl_cust_id" runat="server" Text='<%#Eval("s_id")%>' Visible="false"></asp:Label></td>
